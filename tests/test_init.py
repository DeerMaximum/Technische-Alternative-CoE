...
@pytest.mark.asyncio
async def test_config_migration_from1_1_no_send_config(hass: HomeAssistant) -> None:
    """Test the migration to a new configuration layout with no send config."""
